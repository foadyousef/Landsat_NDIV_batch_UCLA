...
```{r output, include=TRUE, message=FALSE}
indir <- "C:/Users/fyousef/Documents/ESPA_data/Syngenta/Sampledata/2-simple_vis/"
outdir <- "C:/Users/fyousef/Documents/ESPA_data/Syngenta/Sampledata/2-simple_vis/out/"
dir.create(outdir, showWarning=FALSE)
crop_file<- paste0("C:/Users/fyousef/Documents/ESPA_data/Syngenta/Sampledata/shpfile/CO5.shp")
```
...
processLandsat(x=mylist[2], vi='ndvi', outdir=outdir, srdir=outdir, delete=TRUE, 
